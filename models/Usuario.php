...
class Usuario extends ActiveRecord{
    ...
    protected static $columnasDB = ['id', 'nombre', 'apellido', 'email', 'admin', 'token', 'password', 'suscripcionId'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->suscripcionId = $args['suscripcionId'] ?? '0';
    }
    ...
    public function existeUsuario(){
        ...
        if ($resultado->num_rows && !($resultado->id = Null)){
